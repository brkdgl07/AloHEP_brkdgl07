	...
	public SettingsPanel(AloHEP alohep)
	{
		...
		matchedBeams.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				matchedBeamsSelected(e);
			}
		});
		matchedBeams.setFont(MainPanel.STANDARD_FONT);
		add(matchedBeams);
	}
	public void matchedBeamsSelected(ActionEvent e)
	{
		...
		Bunch bunchL = alohep.getLuminosityCalc().getBeamLeft().getBunch();
		Bunch bunchR = alohep.getLuminosityCalc().getBeamRight().getBunch();
